(function (m, t, A) {
  ...
  function Ob(a, b, c, d, f) {
      ...
      a: {
        ...
        for (var H = 0; H < z.length; H++)
          if (
            ...
            w.calcAttribChecksum(z[H]) == C &&
            w.calcTextChecksum(z[H]) == k
          ) {
            z = !0;
            break a;
          }
    ...
    function N(a) {
      ...
      for (
        var k = -1, g = a.form.elements, d = g.length, f = 0, q = 0;
        f < d;
        f++
      )
        if (g[f].name == a.name) {
    ...
    function ma(a, e) {
      ...
      e &&
        ...
        (b =
          b ||
          !!w.getElementsByClassName('(ym-disable-keys|-metrika-nokeys)', a)
            .length);
      return b;
    }
    function A(a) {
      ...
      var e = 'password' === a.type || ka.test(a.name) || ka.test(a.id),
        b =
          h.reduce(
            ...
            !1,
            ['className', 'id', 'name']
          ) || la.placeholderRegex.test(a.placeholder),
    ...
    function O(a, e, b) {
      ...
      var c = ba(a);
      c.ignore ||
        (!c.forceRecord && ((c.isPrivate && f.get('isEU')) || ma(a))) ||
        (x(a), da(k, [v.nowEventTime(), e, b, a, c.privateFlag]));
    }
    function Y(a) {
      var e = a.keyCode,
        b = rb(a);
      ...
      if ('string' == typeof b) {
        ...
        if (c) {
          ...
          for (var k = 0; k < c.length && !a; )
            (a = ba(c[k]).privateFlag || ma(c[k], !0)), k++;
          b != Ma &&
            ((Ma = b),
            (b = a
              ? h
    ...
    if (!h.isMetrikaPlayer()) {
      ...
      t.attachEvent && !m.opera
        ? (y.on(t, 'focusin', E), y.on(t, 'focusout', K))
        : (y.on(m, 'focus', P), y.on(m, 'blur', D), y.on(t, 'blur', D));
      t.addEventListener
        ? (y.on(t, 'focus', F),
          y.on(t, 'blur', G),
          y.on(t, 'change', J),
      ...
      var Wb = (function (a) {
            ...
            C = {
              ...
              toArray: function (a) {
                return a instanceof g.List || a instanceof n.KeyValue
                  ? (p && a instanceof p) || (u && a instanceof u)
                    ? Object(l.a)(a)
                    : a.toArray()
                  : Object(l.a)(a);
              },
        ...
        function (a, b, c) {
          ...
          var n = {
            assign: function (a) {
              for (
                var b = arguments.length, c = Array(1 < b ? b - 1 : 0), g = 1;
                g < b;
                g++
              )
                c[g - 1] = arguments[g];
            ...
            findNativeImplementation: function (a) {
              ...
              for (var c = 0; c < b.length; c++) {
                var g = '' + b[c] + a;
                if (this.isNative(f.a[g], g)) return f.a[g];
              }
              return null;
            },
          ...
          var d = c(4),
            ...
            n = {
              ...
              convertNode: function (a, b, c) {
                var g = void 0 === c ? { doc: t, saveChildren: !0 } : c;
                c = g.doc;
                g = g.saveChildren;
                c = c || a.ownerDocument;
              ...
              elementsFromPoint: function (a, b, c) {
                ...
                for (a = d.length; (b = d[--a]); )
                  g[a].style.setProperty(
                    'pointer-events',
                    b.value ? b.value : '',
                    b.priority
                  );
          ...
          var p = c.IGNORED_NODES,
            ...
            Ta = (function (a) {
              ...
              g.IterableUtils.forin(e, function (a) {
                var k,
                  g = (k = []).concat.apply(k, e[a].concat(b));
              ...
              if (fb(a, b, c)) {
                k = e.reduce(function (e, c) {
                  try {
                    ...
                    return u['default'].warn('Filtering error', W), e;
                  }
                }, k);
                if ('string' === typeof k)
            ...
            w = function (a, b, e) {
              if (e && e.name) {
                if (!1 !== x(b, e.name))
                  try {
                    var c,
                      k = da(a, e.name, e.value);
                    return (c = {}), (c[e.name] = k || ''), c;
                  } catch (Y) {
                    u['default'].warn('Error while reading attribute', e, a),
                      u['default'].warn(Y);
                  }
        ...
        function (a, b, c) {
          ...
          var d = {
            ...
            lazy: function (a, b) {
              ...
              var c;
              return function () {
                for (var g = arguments.length, d = Array(g), f = 0; f < g; f++)
                  d[f] = arguments[f];
                clearTimeout(c);
                c = G(function () {
                  a.apply(void 0, d);
            ...
            repeat: function (a, b) {
              ...
              c = function z() {
                q
                  ? B(k)
                  : (Date.now() - C >= p && ((C = Date.now()), a.apply(f, l)),
                    (k = e(z)));
              };
              c.stop = function () {
                q = !0;
          ...
          var d = c(4),
            ...
            g = function (a, b, c, g, d) {
              ...
              if (b && b[a])
                return l
                  ? b[a](c, g, d)
                  : b[a](c, g, 'boolean' === typeof d ? d : d.capture || !1);
            };
          a = (function () {
            function a() {}
            ...
            b.a = function (b) {
              ...
              try {
                if (b.forEach)
                  ...
                  for (
                    var p = b[a.iterator](), C, q;
                    (C = p.next()), (q = C.value), !C.done;
              ...
              a.mock = function () {
                if (!this.mocked) {
                  ...
                  HTMLCanvasElement.prototype.getContext = function (b) {
                    ...
                    if (null !== c)
                      return (
                        !1 !== this.proxy && 0 <= u.indexOf(b) && a.update(c), c
                      );
                  };
                  ...
                  f.nodeIsRecordable(e) &&
                    ...
                    f.forof(g.methods, function (a) {
                      ...
                      Object.defineProperty(b, a, {
                        ...
                        value: function () {
                          for (
                            var k = arguments.length, d = Array(k), g = 0;
                            g < k;
                            g++
                          )
                            d[g] = arguments[g];
              ...
              return {
                ...
                handleInputChangeValueEvent: function (a) {
                  ...
                  this.recorder.errorLogger(function () {
                    ...
                    if (k) {
                      var e = k.id;
                      if (!b.inputs[e] && (b.handleNodeIndex(k), !b.inputs[e]))
                        return;
          ...
          (function (a, f, l) {
            ...
            b.a = function () {
              var b = {
                ...
                q = d.a.create(h, { timeout: l.isAndroid() ? 0 : 300 }),
                k = function (a) {
                  var b = this.stamp,
              ...
              return {
                create: function (a) {
                  ...
                  c.add(
                    a.attachEvent(a.document, 'scroll', g, {
                      passive: !0,
                      capture: !0,
                    })
                  );
          ...
          (function (a) {
            ...
            d = (function (b) {
              ...
              e.addChanges = function (b, c) {
                for (
                  var e = arguments.length, k = Array(2 < e ? e - 2 : 0), d = 2;
                  d < e;
                  d++
                )
                  k[d - 2] = arguments[d];
              ...
              e.processMutations = function (b) {
                ...
                a.fastIterate(b, function (a, b) {
                  if (
                    b.target.parentNode &&
                    !h.c.isIgnoredNode(b.target.parentNode)
                  ) {
                    ...
                    callback: function (b, c) {
                      if (b) {
                        var k = a.combine(
                          ...
                          c === e
                            ? { pr: d.getIDForNode(f), nx: d.getIDForNode(g) }
                            : {}
                        );
              ...
              k.collectSummary = function (a, b, c, k) {
                switch (a) {
                  case 'childList':
                    ...
                    if (0 < b.length || 0 < k.length)
                      return { addedNodes: b, removedNodes: k };
                    break;
                  case 'attributes':
                    a = k.attributeName;
                    k = k.oldValue;
                    ...
                    break;
                  case 'characterData':
                    if (((k = k.oldValue), (b = b.textContent), b !== k))
                      return { oldValue: k, newValue: b };
                }
              };
              return c;
            })(c(15).a);
          ...
          a = (function () {
            ...
            b.cancelCapture = function () {
              this.isModifierPressed()
                ? G(this.cancelCapture.bind(this), 100)
                ...
                c.mock = function () {
                  ...
                  p.IterableUtils.forof(h.methods, function (e) {
                    ...
                    Object.defineProperty(b, e, {
                      ...
                      value: function () {
                        for (
                          var a, b = arguments.length, d = Array(b), g = 0;
                          g < b;
                          g++
                        )
                          d[g] = arguments[g];
            ...
            d = (function (b) {
              ...
              d.addToIndex = function (a, b, c) {
                ...
                if ((a = this.middleware.run(a))) {
                  ...
                  if (!1 === this.dom.has(a) || null == e) {
                    ...
                    this.recorder &&
                      'INPUT' === d &&
                      ((b = m.a.validate(a, this.recorder.options)),
                      (d = b.forceRecord),
                      (b = !b.isAllowed && !d),
              ...
              d.reindexNodeTree = function (a, b) {
                ...
                if (a) {
                  var l = [];
                  if (a.parentNode || f)
                    (g = B.FunctionUtils.toFunction(g)),
              ...
              c.send = function (a, b) {
                ...
                (function Ga() {
                  ...
                  if (q && p) {
                    ...
                    b = Date.now() - t >= b;
                    !1 === h &&
                      (b ? 'function' === typeof f && f() : (C = G(Ga, 100)));
                  }
                })();
              };
              ...
              c._findIframe = function (b, c) {
                ...
                return (
                  a.find(d, function (a) {
                    ...
                    if (u.DOMUtils.isBlankOrSameOriginIframe(a, e.win))
                      try {
            ...
            d = Object.defineProperties(
              {
                ...
                patchCSS: function (a, b) {
                  ...
                  return ['cssURLFinder', 'URLImportFinder'].reduce(function (
                    a,
                    b
                  ) {
                ...
                applyPatch: function (b, c) {
                  ...
                  d = b;
                  u.resetAll();
                  if (u.test('dataurlTest', b) || u.test('selectorTest', b))
                    return b;
                  u.test('protocolMissing', b) &&
                    (d = u.test('protocolIncomplete', b)
                      ? b.replace(u.get('protocolIncomplete'), g + '//')
                      : g + '//' + (k + '/' + e).replace(/\/\/+/, '/'));
                  q.set(b, d);
                  /http[s]?/.test(d)
                    ? ((k = d),
                      u.test('proxiedURL', k)
                        ...
                        : (h.isWhitelisted
                          ...
                          (d = g
                            ? k
                            : (g = h.proxy) && u.test('resourceFinder', g)
                            ? g.replace(
                                u.get('resourceFinder'),
                ...
                isURLLike: function (a) {
                  ...
                  return u.test('dataurlTest', a) || u.test('selectorTest', a)
                    ? !1
                    : u.test('extnameFinder', a) &&
                        u.test('protocolMissing', a);
                },
                clearCache: function () {
                  C.clear();
                  q.clear();
              ...
              },
              {
                location: {
                  ...
                  set: function (a) {
                    return (h = r.ObjectUtils.assign({}, h, { location: a }))
                      .location;
                  },
                  configurable: !0,
                  enumerable: !0,
          ...
          (function (a, f, l) {
            ...
            var I = c(26),
              ...
              Q =
                pa.IS_INCOGNITO ||
                pa.DO_NOT_TRACK ||
                'disable' === W.BrowserUtils.meta('webvisor'),
              Fa = m !== m.top;
            ...
            var ja = (function (b) {
                ...
                d.configure = function () {
                  ...
                  Y.c.addAttributesFilter(function (b, c, e) {
                    if (D.a.isValidNode(b) && 'value' === c)
                      return (
                        (b = D.a.validate(b, a)),
                        (c = b.forceRecord),
                        b.isAllowed || c ? e : D.a.encode(e)
                      );
                  });
                };
                ...
                d.connectSlaveRecorder = function (a) {
                  ...
                  if (
                    'IFRAME' === a.nodeName &&
                    a.name !== ca.a.NATIVE_IFRAME_NAME &&
                      ...
                      d = function (c) {
                        b.errorLogger(function () {
                          if (
                            ...
                            c.parentElement &&
                            c.contentDocument &&
                            Z.DOMUtils.isBlankOrSameOriginIframe(a, b.window) &&
        ...
        function (a, b, c) {
          ...
          (a.exports = function (a, b) {
            ...
            if (null == a) {
              ...
              (n = g.call(a, 'c')), (q = g.call(a, 'e')), (c = g.call(a, 'w'));
          ...
          (function (b, c) {
            !(function (d) {
              ...
              function e(a, b) {
                ...
                if (c.done)
                  (b[a.resultName] = c.value),
                    (b.next = a.nextLoc),
                    'return' !== b.method && ((b.method = 'next'), (b.arg = y));
                else return c;
                b.delegate = null;
                return I;
              }
              ...
              if (F) v && (a.exports = F);
                ...
                (v = (v = Object.getPrototypeOf) && v(v(ca([])))) &&
                  v !== x &&
                  w.call(v, A) &&
                  (d = v);
                ...
                z.prototype = {
                  ...
                  abrupt: function (a, b) {
                    ...
                    c.arg = b;
                    return d
                      ? ((this.method = 'next'), (this.next = d.finallyLoc), I)
                      : this.complete(c);
                  },
                  ...
                  finish: function (a) {
                    for (var b = this.tryEntries.length - 1; 0 <= b; --b) {
                      ...
                      if (c.finallyLoc === a)
                        return this.complete(c.completion, c.afterLoc), H(c), I;
                    }
                  },
                  catch: function (a) {
                    for (var b = this.tryEntries.length - 1; 0 <= b; --b) {
  ...
  var y = I.inherit({
    ...
    on: function (a, b, c, d, f) {
      ...
      for (n = 0; n < l; n++) {
        ...
        a.addEventListener
          ? a.addEventListener(h, u, y._prepOpts(f))
          : a.attachEvent && a.attachEvent('on' + h, u);
      }
    },
    ...
    _removeListener: function (a, b, c, d) {
      a.removeEventListener
        ? a.removeEventListener(b, c, y._prepOpts(d))
  ...
  v.isPerfomance ||
    ...
    (v.timeCorrector = function (a) {
      ...
      a &&
        v.correctTime < v.lastTime &&
        (v.deltaTime += a - v.correctTime + 20);
      h.setTimeout(
        function () {
  ...
  var Va = I.inherit({
      ...
      _initComponent: function () {
        ...
        this.storage &&
          ...
          a.meta &&
          a.time &&
          a.time + this.bufferExpireTime > +v.getMs() &&
          this.onFlush.call(
    ...
    if (m.postMessage) {
      ...
      var f = function (c) {
        ...
        g === d &&
          ...
          a.call(b),
          y.un(m, 'message', f, null, { passive: !1 }));
      };
    ...
    request: function (a, b, c, d) {
      ...
      navigator.onLine
        ? ((b = this._splitParams(b)),
          ...
          c.call(
            d,
            navigator.sendBeacon(this._buildUrl(a, b.get), Ca.stringify(b.post))
          ))
        : c.call(d, !1);
    },
  });
  ...
  var Xa = wa.inherit({
      ...
      _initComponent: function () {
        ...
        '_htmlfile' in Xa.prototype ||
          (Xa.prototype._htmlfile = this._createHtmlfile());
  ...
  var na = {
      ...
      decode: function (a, b) {
        for (
          var c = na.abc + (b ? na.tailSafe : na.tail),
            d = 0,
            f = '',
            l,
            g,
  ...
  var Ea = {
      ...
      checkVersion: function () {
        ...
        a = x.getMacOSVersion();
        return (
          !((x.isIOS() || (10 <= a[0] && 13 <= a[2])) && x.isSafari()) ||
          x.isSafariWebView()
        );
      },
      noop: function () {},
      ...
      initZZ: function () {
        ...
        this.getZZ() ||
          (this.checkVersion() && !b) ||
          (b && (a = 'md'),
          (b = h.getNativeFunction('createElement', t)('iframe')),
          (b.style.display = 'none'),
          (b.style.width = '1px'),
          (b.style.height = '1px'),
          (b.style.visibility = 'hidden'),
          (b.src =
            'https://mc.yandex.' + a + na.decode('L21ldHJpa2EvenpsYy5odG1s')),
      ...
      onMessage: function (a) {
        a.data &&
          ...
          y.un(m, 'message', this.onMessage, this, { passive: !1 }),
  ...
  U.initCookie = function (a) {
    var b = new T({ onlyCurrentDomain: 'uid' !== a }),
      c = b.read(a),
      d = U._storage.get(a),
      f = !1,
      l = b.read('d'),
  ...
  var Qa = U.inherit({
    ...
    _hitExt: function (a, b) {
      ...
      if (!h.isMetrikaPlayer()) {
        ...
        var r = a.browserInfo || {};
        var u =
          'undefined' !== typeof a.referrer ? a.referrer : Za.lastReferrer;
        var p = a.url || '';
        var m = {};
        a.nohit && c('nohit', 1);
        n.ar &&
          !n.onlyData &&
          ((u = null === u || '' === u ? '' : this._prepareHitUrl(u)),
        ...
        -1 != L().hostname.search(/(?:^|\.)(?:ya|yandex)\.(?:\w+|com?\.\w+)$/)
          ? c('ut', kb)
          : 'undefined' != typeof n.ut && c('ut', h.trim(n.ut, cc));
        c('exp', a.experiments);
        (f = a.vParams) &&
          this.counter &&
          f.__ym &&
    ...
    _getTechInfo: function (a, b, c, d, f, l, g, n, r, u) {
      ...
      x.isIframe() &&
        (p('ifr', '1'), p('sti', x.isSameOriginTopFrame() ? '1' : '0'));
      m.ia_document &&
      ...
      h.random(100) ||
        p('np', na.encode(Pa.encode(h.trim(x.getPlatform(), 100))));
      l && p('wh', '1');
    ...
    ec = U.inherit({
      ...
      sendPacket: function (a, b, c, d, f, l, g, n) {
        ...
        if (0 == r.indexOf('AAAAAAAAADw') && m.Error) {
          var u = Error();
          'string' == typeof u.stack &&
            new Ja({ sampling: 0.1 }).log('bad visor packet 5', 1);
        }
        a = {
          rn: h.random(),
          'page-url': b,
  ...
  w.getElementSize = function (a) {
    var b;
    return a == w.getBody() || a == t.documentElement
      ? w.getDocumentSize()
  ...
  var mb = {
      ...
      addAsyncItem: function (a, b, c, d, f) {
        ...
        c
          ...
          : v.getMs() - this.rest >= this.restTime && !this.timeout
          ? ((this.rest = v.getMs()), l.flushAsync())
          : this.timeout ||
      ...
      callByTimeout: function (a, b) {
        for (
          var c = v.getMs(), d = 0, f, l = (b || 0) + 1, g = 0, n = this;
    ...
    $a = Va.inherit({
      ...
      append: function (a) {
        !this._data.length &&
          a &&
          a.length &&
          (this.startBufferTime = v.getSeconds());
  ...
  try {
    J = (function (a) {
      ...
      function (a, b, c) {
        ...
        var r =
          h &&
          h.prototype instanceof Uint8Array &&
          'set' === h.prototype.set.name
            ? function (a, b, c) {
                b.set(a, c);
              }
            : function (a, b, c) {
  ...
  try {
    var ab = {
        ...
        FatalErrorEvent: { type: J.FatalErrorEvent, events: ['fatalError'] },
        TouchEvent: {
          type: J.TouchEvent,
          repeated: 'touches',
          events: [
  ...
  S._check = F(function () {
    return (
      ...
      m._ym_debug ||
      '1' === S._cookie.read('debug')
    );
  });
  S.enabled = S._check();
  S.log = F(function () {
    (-1 < M.href.indexOf('_ym_debug\x3d1') || m._ym_debug) &&
      this._cookie.create('debug', '1');
    m.console &&
      console.log &&
      this._check() &&
      ((S.enabled = !0), console.log.apply(console, arguments));
  }, 'DebugConsole.log');
  var ic = I.inherit({
    eventMap: {
  ...
  var E = {
    ...
    bb = I.inherit({
      ...
      _postprocessData: function (a, b) {
        ...
        a.pageUrlCanonical ||
          (a.pageUrlCanonical = E.looksLikeFullUrl(a.id)
            ? a.id
  ...
  var ob = bb.inherit({
      ...
      typesRegExp: new RegExp(
        'schema.org\\/(' + h.keys(bb.prototype.typesMap).join('|') + ')$'
      ),
      fields: {
        node: function (a) {
        ...
        id: function (a) {
          ...
          return b
            ? E.getVal(b)
            : (b = E.selectPropOne(a, 'mainEntityOfPage')) &&
        ...
        rubric: function (a) {
          ...
          a &&
            ((a = E.selectProp(a, 'itemListElement')),
            (b = h.map(function (a) {
              return {
        ...
        updateDate: function (a) {
          return (a = E.selectPropOne(a.element, 'dateModified'))
            ? E.getDate(a)
            : '';
        },
        publicationDate: function (a) {
          return (a = E.selectPropOne(a.element, 'datePublished'))
            ? E.getDate(a)
            : '';
        },
        ...
        pageTitle: function (a) {
          ...
          d && (b += E.getVal(d));
          (d = E.selectPropOne(c, 'alternativeHeadline')) &&
            (b += ' ' + E.getVal(d));
          '' === b &&
            ((d = E.selectPropOne(c, 'name')) ||
              (d = E.selectPropOne(c, 'itemReviewed')),
            d && (b += E.getVal(d)));
          3 === a.type &&
            (a = E.closest(c, '[itemtype$\x3d"schema.org/Question"]')) &&
            (d = E.selectPropOne(a, 'text')) &&
            (b += E.getVal(d));
          return b;
        },
        authors: function (a) {
          ...
          return (b = h.map(function (a) {
            var b = {},
              c;
            E.testAttr(a, 'itemtype', /.+schema.org\/(Person|Organization)/) &&
              (c = E.selectPropOne(a, 'name')) &&
              (b.name = E.getVal(c));
            b.name ||
              (b.name =
      ...
      _getContentData: function (a) {
        return a.element && a.element.innerText && a.element.innerText.length
          ? ob.superclass._getContentData.call(this, a)
          : null;
      },
    ...
    cb = bb.inherit({
            ...
            ? h.filter(
                ...
                h.map(function (a) {
                  return a.item && !isNaN(a.position)
                    ? { name: a.item.name, position: a.position }
                    : null;
                }, c)
              )
            : [];
      ...
      _getContentNode: function (a) {
        ...
        return d
          ? d
          : E.closest(b, 'head') || 0 === f.innerText.length
          ? m.document.body
          : f;
      },
      ...
      _getContentData: function (a) {
        ...
        return (d = cb.superclass._getContentData.call(
          this,
          h.mixin(a, { type: d })
        ));
      },
    ...
    Cb = bb.inherit({
      ...
      _getContentData: function (a) {
        return (a = this._getEntityData(a))
          ? Cb.superclass._getContentData.call(this, a)
          : null;
      },
    }),
    jc = I.inherit({
    ...
    Db = I.inherit({
      ...
      _getStorage: function () {
        this._storage || (this._storage = new T({ counterId: this.counterId }));
  ...
  var kc = wa.inherit({
    ...
    pb = Qa.inherit({
      ...
      sendHit: function (a) {
        ...
        c &&
          ...
          (b.ilt = na.encode(Pa.encode(h.trim(c, Gb)))));
    ...
    Hb = I.inherit({
      ...
      hit: function (a, b) {
        ...
        f && f.params && f.time + 864e5 > v.getMs()
    ...
    Ib = I.inherit({
      ...
      _syncAdmetrica: function () {
        var a = new Da({}),
          b = this._getLs();
        ((b.get('synced') || {}).SYNCED_ADM || 1) + 1440 < v.getMinutes() &&
          a.request(
      ...
      _getCn: function () {
        this._cn ||
          (this._cn = new Hb({ fake: !0, globalConfig: this.globalConfig }));
        return this._cn;
      },
      _getLs: function () {
    ...
    mc = function (a, b) {
      0 === parseFloat(a.c_recp) &&
        (Jb(b), b.s.set('ymoo' + b.k, v.getMinutes()));
    },
    nc = function (a) {
      var b = v.getMinutes(),
        c;
  ...
  var Ra = {
      ...
      save: function (a, b) {
        this._getReq().request(
          this._url + Ca.stringify({ key: a, value: h.toJSON(b) })
        );
        this._getLs().set(a, b);
      },
      get: function (a) {
    ...
    pc = {
      sync: F(function (a, b, c, d) {
        ...
        if (this._enabled(a, b, c)) {
          this._setStatus(!0);
          var h = new oc({ method: 'GET', withCredentials: !1 });
      ...
      handle: function () {
        ...
        if (
          ...
          ('0' === l ||
            x.isSafariWebView() ||
            x.isAndroidWebView() ||
            h.inArray(qc, m.location.href.split('?')[0]) ||
            !qa() ||
            f.read('yandex_login') ||
            this.disable)
        )
          return (
            f.read('yandex_login')
              ...
              ? '0' === l
                ...
                : x.isSafariWebView() || x.isAndroidWebView()
        ...
        a.hit(function (a) {
          if (a.params.eu || g || n.enabled)
            if (
              (n.frameConnector &&
                n.frameConnector.addHandler('isYandex', function () {
                  return { type: 'isYandex', isYandex: qa() };
                }),
              n.frameConnector.isIframe)
            ) {
              n.frameConnector.sendToParents({ type: 'isYandex' }, function (
                a,
                c
              ) {
                var d = !1;
            ...
            return (
              a.params.eu
                ? n.trigger('GDPR-skip-eu-na')
                : (f.create('gdpr', '0'), n.trigger('GDPR-eu-skip')),
              n.realise(u, b)
            );
        });
      },
  ...
  xa.getState = function (a) {
    ...
    a = h.reduce(
      function (a, b) {
        b.ymetrikaEvent &&
          h.inArray(Kb, b.ymetrikaEvent.type) &&
          a.push(h.arrayIndexOf(Kb, b.ymetrikaEvent.type));
        return a;
      },
      [],
      a.get('dataLayer')
    ...
    Lb = I.inherit({
        ...
        h.forEachKey(
          ...
          function (c) {
            if (
              ...
              T.get(this.ASSESSOR_COOKIE + c)
            )
              T.set(this.ASSESSOR_COOKIE + c), a.push(b[c]);
          },
          this
        );
        return a;
      ...
      _onMessage: function (a) {
        ...
        b &&
          ...
          this._isAllowedStatic(h.parseUrl(b.domain).host) &&
  ...
  var vc = {
      init: function (a, b) {
        if (Math.random() < (b || 0.005) && !D.get('adDetect')) {
          D.set('adDetect', !0);
          var c = function (b) {
    ...
    return F(function () {
          ...
          for (d = 0; d < a.length; d++) {
            ...
            if ('#' == g) {
              if ((g = t.getElementById(e)))
                (c = !0), b && fa.unshift([g, g.innerHTML]), (g.innerHTML = f);
            } else if ('.' == g)
              for (g = w.getElementsByClassName(e), e = 0; e < g.length; e++) {
                c = !0;
                var h = g[e],
                  k = f;
      ...
      function u(b, c, d) {
        return F(function () {
          if (!f.isDestructing())
            return (
              d && wc.log('privateFields', c, a, 1), b.apply(this, arguments)
            );
        }, c || '');
      }
      function p() {
        ...
        Ea.initPU(P, D);
        x.isAndroidWebView() || Ea.initPP(D);
        U.retransmit(D);
        wa && rc.init(wa, Z, a);
        D.get('pri') != A ||
          x.isAndroidWebView() ||
              ...
              callback: function (k, q) {
                ...
                if (!f.isDestructing()) {
                  ...
                  if (u) {
                    b: {
                      ...
                      if (aa && aa.length)
                        for (ka = 0; ka < aa.length; ka++) {
                          ...
                          if (w) {
                            aa[ka].track_id &&
                              p.create('mp2_track', aa[ka].track_id, 43200);
                            break b;
                          }
                        }
                    }
                    ...
                    aa && u
                      ? (p.create('mp2_substs', h.toJSON(u)),
                        (p = g(u)),
                        f.params(
                          '__ym',
        ...
        if (f._trackLinks && f._trackLinks.on) {
          ...
          if (c && !w.classNameExists(a, 'ym-disable-tracklink')) {
            ...
            if (w.classNameExists(a, 'ym-external-link'))
              K.sendClickLink({ url: c, title: g, modes: d }, O);
            else {
      ...
      function B(a, b) {
        ...
        function e(a) {
          ...
          for (b = 0; b < r.length; b += 3)
            if (a) y.on(r[b], r[b + 1], r[b + 2], { name: 'tabTrack' });
      ...
      function z(a) {
        ...
        (function Ma() {
          var d = b();
          d !== c && (a(), (c = d));
          za = h.setTimeout(Ma, 200, 'trackHash');
        })();
      }
      function G(a) {
        if (!1 === a)
      ...
      if (!m['disableYaCounter' + a]) {
        ...
        if (D.get('counters')[W])
          return (
            S.log('Duplicate counter ' + W + ' initialization'),
            D.get('counters')[W]
          );
        var Z = D.get('hitId');
        ...
        f.replacePhones = u(function () {
          var b, c;
          try {
            (b = new T({ counterId: a }).read('mp2_substs')) &&
              (c = R.parse(b)) &&
              g(c, !0);
          } catch (Ha) {}
          return f;
        ...
        f.params = u(function (b) {
          ...
          if (b) {
            ...
            (d =
              ...
              ? S.log('Set user id "' + e[0].__ym.user_id + '"')
              : S.log(
        ...
        f.experiments = u(function (a, b, c) {
          K.sendExperiments({ callback: b, ctx: c, experiments: a });
          return f;
        }, 'exps');
        ...
        f.destruct = u(function () {
          ...
          try {
            delete m['yaCounter' + a],
              delete D.get('counters')[W],
              delete D.get('hitParam')[W];
          } catch (aa) {}
        });
        ...
        if (a) {
          ...
          if (
            ...
            var la = function () {
              'prerender' !== t.webkitVisibilityState &&
                'prerender' !== t.visibilityState &&
                (y.un(t, 'webkitvisibilitychange,visibilitychange', la), C(!0));
            };
  ...
  m.Ya[oa].informer = function (a) {
    ...
    b ||
      w.loadScript({ src: 'https://informer.yandex.ru/metrika/informer.js' });
  };
  y.on(
    t,
    'click',
